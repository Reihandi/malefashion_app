                                                    ...
                                                    <ul class="nice-scroll">
                                                        <li>
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-tabel" for="product_category">sepatu</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-tabel" for="product_category">Jaket</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-tabel" for="product_category">Kaos</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-tabel" for="product_category">Tas</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-tabel" for="product_category">Syal</label>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </div>
